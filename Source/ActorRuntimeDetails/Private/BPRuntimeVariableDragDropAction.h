...
class FKismetRuntimeVariableDragDropAction : public FMyBlueprintRuntimeItemDragDropAction
{
public:
	DRAG_DROP_OPERATOR_TYPE(FKismetRuntimeVariableDragDropAction, FMyBlueprintRuntimeItemDragDropAction)
	...
	static TSharedRef<FKismetRuntimeVariableDragDropAction> New(TSharedPtr<FEdGraphSchemaAction> InAction, FName InVariableName, UStruct* InVariableSource, FNodeCreationAnalytic AnalyticCallback)
	{
		TSharedRef<FKismetRuntimeVariableDragDropAction> Operation = MakeShareable(new FKismetRuntimeVariableDragDropAction);
...
protected:
	 /** Construct a FKismetRuntimeVariableDragDropAction */
	FKismetRuntimeVariableDragDropAction();
	...
	// FMyBlueprintRuntimeItemDragDropAction interface
	virtual UBlueprint* GetSourceBlueprint() const override;
	// End of FMyBlueprintRuntimeItemDragDropAction interface
